...
import { d as useRuntimeConfig$1, $ as $fetch, w as withQuery, l as hasProtocol, p as parseURL, m as isScriptProtocol, j as joinURL, n as sanitizeStatusCode, o as createHooks, h as createError$1, q as isEqual, r as klona, t as toRouteMatcher, v as createRouter, x as defu, y as stringifyParsedURL, z as stringifyQuery, A as parseQuery, B as defuFn } from '../runtime.mjs';
...
const presets_pWvhvkc3SC = /* @__PURE__ */ defineNuxtPlugin(() => {
...
const variables_M3EiEc4WpY = /* @__PURE__ */ defineNuxtPlugin(() => {
  const appConfig2 = useAppConfig();
  const root = computed(() => {
    return `:root {
...
const AppComponent = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-ea739b84"]]);
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DvkTmB_a.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-ALNYlmMI.mjs').then((r) => r.default || r));
